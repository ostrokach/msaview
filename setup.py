...
data_files_spec = [
    ("share/jupyter/nbextensions/msaview", nb_path, "*.js*"),
    ("share/jupyter/lab/extensions", lab_path, "*.tgz"),
    ("etc/jupyter/nbconfig/notebook.d", HERE, "msaview.json"),
]
...
setup_args = dict(
    name=name,
    description="A set of Jupyter widgets useful for analyzing biological data.",
    version=version,
