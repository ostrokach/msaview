...
# -*- coding: utf-8 -*-
#
# msaview documentation build configuration file
#
...
_version_py = os.path.join(repo, "msaview", "_version.py")
version_ns = {}
...
latex_documents = [
    (master_doc, "msaview.tex", "msaview Documentation", "Alexey Strokach", "manual"),
]
...
man_pages = [(master_doc, "msaview", "msaview Documentation", [author], 1)]
